package org.barrikeit.core.util.search;
...
public class SearchSpecCriteria {
  ...
  public SearchSpecCriteria() {}

  public SearchSpecCriteria(final String key, final SearchOperation operation, final Object value) {
    super();
    this.key = key;
  ...
  public SearchSpecCriteria(
    ...
    if (op != null) {
      if (op == SearchOperation.EQUALITY) { // the operation may be
        // complex operation
