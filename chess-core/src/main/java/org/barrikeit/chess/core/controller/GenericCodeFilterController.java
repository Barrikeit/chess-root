...
import org.barrikeit.chess.core.service.GenericCodeFilterService;
...
@AllArgsConstructor
@Validated
public abstract class GenericCodeFilterController<
    T extends GenericCodeEntity<I, C>,
    I extends Serializable,
    C extends Serializable,
    D extends GenericDto,
    F extends BaseFilter> {

  private final GenericCodeFilterService<T, I, C, D, F> service;
